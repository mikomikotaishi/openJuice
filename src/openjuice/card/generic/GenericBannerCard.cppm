...
public:
    static constexpr u8 ID = std::util::to_underlying(CardType::BANNER); ///< The id of this specific card
private:
    static constexpr CardType CARD_TYPE = CardType::BANNER; ///< The card type of this specific card
