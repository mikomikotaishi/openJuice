 ...
 * providing the BattleMushroomType::DEFENCE_DOWN effect in the game.
 */
export class DefenceDownMushroom final: public BattleMushroomCard {
public:
    static constexpr u16 ID = std::util::to_underlying(BattleMushroomType::DEFENCE_DOWN); ///< The ID of this specific card
private:
