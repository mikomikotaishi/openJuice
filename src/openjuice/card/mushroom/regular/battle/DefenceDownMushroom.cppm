 ...
 * Battle Mushroom providing the BattleMushroomCard::Effect::DEFENCE_DOWN effect in the game.
 */
...
public:
    static constexpr u16 ID = stdx::util::to_underlying(BattleMushroomCard::Effect::DEFENCE_DOWN); ///< The ID of this specific card
private:
    ...
    MUSHROOM_METADATA("CARD_SHROOM_DEFENCEDOWN");
    IMPLEMENT_NOOP();
public:
    /**
