 ...
 * Battle Mushroom providing the BattleMushroomCard::Effect::EVADE_DOWN effect in the game.
 */
...
public:
    static constexpr u16 ID = stdx::util::to_underlying(BattleMushroomCard::Effect::EVADE_DOWN); ///< The ID of this specific card
private:
