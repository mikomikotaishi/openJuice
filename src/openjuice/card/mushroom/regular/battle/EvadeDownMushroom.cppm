 ...
 * providing the BattleMushroomType::EVADE_DOWN effect in the game.
 */
export class EvadeDownMushroom final: public BattleMushroomCard {
public:
    static constexpr u16 ID = std::util::to_underlying(BattleMushroomType::EVADE_DOWN); ///< The ID of this specific card
private:
