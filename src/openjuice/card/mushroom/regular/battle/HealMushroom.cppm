 ...
 * providing the BattleMushroomType::HEAL effect in the game.
 */
export class HealMushroom final: public BattleMushroomCard {
public:
    static constexpr u16 ID = std::util::to_underlying(BattleMushroomType::HEAL); ///< The ID of this specific card
private:
