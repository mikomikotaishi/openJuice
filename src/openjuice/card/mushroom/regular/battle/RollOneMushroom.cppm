 ...
 * providing the BattleMushroomType::ROLL_ONE effect in the game.
 */
export class RollOneMushroom final: public BattleMushroomCard {
public:
    static constexpr u16 ID = std::util::to_underlying(BattleMushroomType::ROLL_ONE); ///< The ID of this specific card
private:
