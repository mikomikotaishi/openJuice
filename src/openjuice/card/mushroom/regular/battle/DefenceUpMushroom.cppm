 ...
 * Battle Mushroom providing the BattleMushroomCard::Effect::DEFENCE_UP effect in the game.
 */
...
public:
    static constexpr u16 ID = stdx::util::to_underlying(BattleMushroomCard::Effect::DEFENCE_UP); ///< The ID of this specific card
private:
