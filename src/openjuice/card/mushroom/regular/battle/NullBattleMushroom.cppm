 ...
 * Battle Mushroom providing the BattleMushroomCard::Effect::NULL_BATTLE effect in the game.
 */
...
public:
    static constexpr u16 ID = stdx::util::to_underlying(BattleMushroomCard::Effect::NULL_BATTLE); ///< The ID of this specific card
private:
