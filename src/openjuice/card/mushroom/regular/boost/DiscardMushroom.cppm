 ...
 * Boost Mushroom providing the BoostMushroomCard::Effect::DISCARD effect in the game.
 */
...
public:
    static constexpr u16 ID = stdx::util::to_underlying(BoostMushroomCard::Effect::DISCARD); ///< The ID of this specific card
private:
