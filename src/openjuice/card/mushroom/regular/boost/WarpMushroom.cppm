 ...
 * providing the BoostMushroomType::WARP effect in the game.
 */
export class WarpMushroom final: public BoostMushroomCard {
public:
    static constexpr u16 ID = std::util::to_underlying(BoostMushroomType::WARP); ///< The ID of this specific card
private:
