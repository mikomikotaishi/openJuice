 ...
 * providing the BoostMushroomType::DRAW effect in the game.
 */
export class DrawMushroom final: public BoostMushroomCard {
public:
    static constexpr u16 ID = std::util::to_underlying(BoostMushroomType::DRAW); ///< The ID of this specific card
private:
