 ...
 * Boost Mushroom providing the BoostMushroomCard::Effect::DRAW effect in the game.
 */
...
public:
    static constexpr u16 ID = stdx::util::to_underlying(BoostMushroomCard::Effect::DRAW); ///< The ID of this specific card
private:
