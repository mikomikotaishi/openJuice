 ...
 * providing the BoostMushroomType::LOSE_STARS effect in the game.
 */
export class LoseStarsMushroom final: public BoostMushroomCard {
public:
    static constexpr u16 ID = std::util::to_underlying(BoostMushroomType::LOSE_STARS); ///< The ID of this specific card
private:
