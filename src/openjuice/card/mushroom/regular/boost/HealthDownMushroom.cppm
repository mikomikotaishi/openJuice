 ...
 * providing the BoostMushroomType::HEALTH_DOWN effect in the game.
 */
export class HealthDownMushroom final: public BoostMushroomCard {
public:
    static constexpr u16 ID = std::util::to_underlying(BoostMushroomType::HEALTH_DOWN); ///< The ID of this specific card
private:
