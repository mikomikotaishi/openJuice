 ...
 * Boost Mushroom providing the BoostMushroomCard::Effect::CONFUSION effect in the game.
 */
...
public:
    static constexpr u16 ID = stdx::util::to_underlying(BoostMushroomCard::Effect::CONFUSION); ///< The ID of this specific card
private:
