 ...
 * Boost Mushroom providing the BoostMushroomCard::Effect::MOVE_UP effect in the game.
 */
...
public:
    static constexpr u16 ID = stdx::util::to_underlying(BoostMushroomCard::Effect::MOVE_UP); ///< The ID of this specific card
private:
