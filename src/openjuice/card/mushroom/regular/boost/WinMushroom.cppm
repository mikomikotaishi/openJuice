 ...
 * providing the BoostMushroomType::WIN effect in the game.
 */
export class WinMushroom final: public BoostMushroomCard {
public:
    static constexpr u16 ID = std::util::to_underlying(BoostMushroomType::WIN); ///< The ID of this specific card
private:
