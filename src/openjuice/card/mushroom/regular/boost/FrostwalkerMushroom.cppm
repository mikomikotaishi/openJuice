 ...
 * Boost Mushroom providing the BoostMushroomCard::Effect::FROSTWALKER effect in the game.
 */
...
public:
    static constexpr u16 ID = stdx::util::to_underlying(BoostMushroomCard::Effect::FROSTWALKER); ///< The ID of this specific card
private:
