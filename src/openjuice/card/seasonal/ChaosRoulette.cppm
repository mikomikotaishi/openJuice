 ...
 *
 * This file contains the implementation of the ChaosRoulette class, which represents the card "Lonely Chariot" in the game.
 */
 ...
 *
 * The ChaosRoulette class extends both BoostCard and SeasonalCard to represent the card "Lonely Chariot" in the game.
 */
...
private:
    ...
    CARD_METADATA("CARD_BOOST_ChaosRoulette", "CARD_ARTIST_JUNPYON");
    IMPLEMENT_NOOP();
public:
    /**
