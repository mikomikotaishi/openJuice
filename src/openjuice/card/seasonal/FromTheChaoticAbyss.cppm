 ...
 *
 * This file contains the implementation of the FromTheChaoticAbyss class, which represents the card "Lonely Chariot" in the game.
 */
 ...
 *
 * The FromTheChaoticAbyss class extends both BoostCard and SeasonalCard to represent the card "Lonely Chariot" in the game.
 */
export class FromTheChaoticAbyss final: public BoostCard, public SeasonalCard {
private:
    ...
    CARD_METADATA("CARD_BOOST_FromTheChaoticAbyss", "CARD_ARTIST_JUNPYON");
    IMPLEMENT_NOOP();
public:
    /**
