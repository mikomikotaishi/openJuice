 ...
 *
 * This file contains the implementation of the GrownupSnowballFight class, which represents the card "Lonely Chariot" in the game.
 */
 ...
 *
 * The GrownupSnowballFight class extends both BoostCard and SeasonalCard to represent the card "Lonely Chariot" in the game.
 */
export class GrownupSnowballFight final: public BoostCard, public SeasonalCard {
private:
    ...
    CARD_METADATA("CARD_BOOST_GrownupSnowballFight", "CARD_ARTIST_JUNPYON");
    IMPLEMENT_NOOP();
public:
    /**
