 ...
 *
 * This file contains the implementation of the ChaoticPool class, which represents the card "Lonely Chariot" in the game.
 */
 ...
 *
 * The ChaoticPool class extends both BoostCard and SeasonalCard to represent the card "Lonely Chariot" in the game.
 */
export class ChaoticPool final: public BoostCard, public SeasonalCard {
private:
    ...
    CARD_METADATA("CARD_BOOST_ChaoticPool", "CARD_ARTIST_JUNPYON");
    IMPLEMENT_NOOP();
public:
    /**
