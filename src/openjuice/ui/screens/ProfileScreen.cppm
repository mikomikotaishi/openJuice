...
export module openjuice.ui.screens:ProfileScreen;
 ...
 * @extends Screen
 */
export class ProfileScreen final: public Screen {
private:
    [[maybe_unused]]
...
public:
     ...
     */
    ProfileScreen(SharedPointer<Game> game, Host& host, SharedPointer<LocalizationService> localization):
