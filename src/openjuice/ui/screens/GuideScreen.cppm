...
export module openjuice.ui.screens:GuideScreen;
 ...
 * @extends Screen
 */
export class GuideScreen final: public Screen {
private:
    [[maybe_unused]]
...
public:
     ...
     */
    GuideScreen(SharedPointer<Game> game, Host& host, SharedPointer<LocalizationService> localization):
