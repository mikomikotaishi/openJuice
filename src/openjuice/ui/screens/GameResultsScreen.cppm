...
export module openjuice.ui.screens:GameResultsScreen;
 ...
 * @extends Screen
 */
export class GameResultsScreen final: public Screen {
private:
    [[maybe_unused]]
...
public:
     ...
     */
    GameResultsScreen(SharedPointer<Game> game, Host& host, SharedPointer<LocalizationService> localization):
