...
export module openjuice.ui.screens:ShopScreen;
 ...
 * @extends Screen
 */
export class ShopScreen final: public Screen {
private:
    [[maybe_unused]]
...
public:
     ...
     */
    ShopScreen(SharedPointer<Game> game, Host& host, SharedPointer<LocalizationService> localization):
